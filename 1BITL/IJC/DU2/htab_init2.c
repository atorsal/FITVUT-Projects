...
// Prelozene: gcc 4.9
// Popis: Vytvorenie a inicializacia tabulky s inou rozpytovacou funkciou
						      ...
						      unsigned htab_size))
{
	...
	if (hash_function_ptr == NULL) {
		fprintf(stderr, "Null hash function pointer.\n");
		return NULL;
	}
	...
	t->size = size;
	t->n = 0;
	t->hash_fun_ptr = hash_function_ptr;
	return t;
}
