...
#ifndef SOURCE_CRC_IMPL_H_
#define SOURCE_CRC_IMPL_H_

#include <stdlib.h>
#include <stdint.h>

const uint32_t CRC32_POLY = 0x04C11DB7U;
const uint32_t CRC32_POLY_REVERSED = 0xEDB88320U;
const uint32_t CRC16_POLY = 0x8005U;
const uint32_t CRC16_POLY_REVERSED = 0xA001U;
const uint32_t CRC32_SEED = 0xFFFFFFFFU;
const uint32_t CRC16_SEED = 0x0U;

// CRC 32 table for CRC32_POLY (0x04C11DB7U)
// source: http://www.ipgp.fr/~tuchais/earthworm/v6.3/src/data_sources/naqs2ew/crc32.c
static const uint32_t crc32_table[] = { 0x00000000, 0x77073096, 0xEE0E612C,
...
// CRC 16 table for CRC16_POLY (0x8005)
// source: https://github.com/torvalds/linux/blob/master/lib/crc16.c#L12
...
/**
 * Calculate CRC32 using table-driven calculation
...
/**
 * Calculate CRC16 using table-driven calculation
 * @param buf input data
 * @param len length of input data
 * @return CRC16 value
 */
...
/**
 * Calculate CRC32 using basic algorithm
 * @param buf input data
 * @param len length of input data
 * @return CRC32 value
 */
...
/**
 * Calculate CRC16 using basic algorithm
 * @param buf input data
 * @param len length of input data
 * @return CRC16 value
 */
...
/**
 * Calculate CRC32 using hardware CRC module
 * @param buf input data
 * @param len length of input data
 * @return CRC32 value
 */
...
/**
 * Calculate CRC16 using hardware CRC module
 * @param buf input data
 * @param len length of input data
 * @return CRC16 value
 */
